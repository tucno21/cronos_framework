...
(function () {
	...
	// Exponer clases y funciones al ámbito global para que blog.js pueda usarlas
	window.TailwindModal = TailwindModal;
	window.DataTable = DataTable;
	window.Swal = Swal;
	window.toastPersonalizado = toastPersonalizado;
	window.mensajeErrorInput = mensajeErrorInput;
	window.limpiarErrrorInput = limpiarErrrorInput;
	window.visorFoto = visorFoto;
})();
