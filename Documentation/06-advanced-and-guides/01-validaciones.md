...
El sistema de validacion permite validar datos desde los controladores usando el metodo `validate()` heredado de `Cronos\Http\Controller`, o de forma desacoplada y automatica mediante **Form Requests** (ver [`Documentation/02-http-and-routing/04-form-requests.md`](../02-http-and-routing/04-form-requests.md)).
