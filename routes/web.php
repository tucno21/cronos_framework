...
Route::get('/dashboard/usuarios', [SpaController::class, 'index']);
Route::get('/dashboard/usuarios/{id}', [SpaController::class, 'index']);
Route::get('/dashboard/categorias', [SpaController::class, 'index']);
Route::get('/dashboard/etiquetas', [SpaController::class, 'index']);
Route::get('/dashboard/comentarios', [SpaController::class, 'index']);
Route::get('/dashboard/orm-lab', [SpaController::class, 'index']);
